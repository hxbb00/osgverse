...
function(DETECT_X64_MICRO_ARCHITECTURE out_vendor out_arch)
  ...
  elseif(_vendor_id STREQUAL "AuthenticAMD")
    ...
    if(_cpu_family EQUAL 26)
      set(MICRO_ARCHITECTURE "amd-1ah" "zen5")
    elseif(_cpu_family EQUAL 25)
      if(_cpu_model LESS 80)
        set(MICRO_ARCHITECTURE "amd-19h" "zen3")
      else()
        set(MICRO_ARCHITECTURE "amd-19h" "zen4")
      endif()
    elseif(_cpu_family EQUAL 24)
      set(MICRO_ARCHITECTURE "amd-18h" "hygon_dhyana")
    elseif(_cpu_family EQUAL 23)
      if(_cpu_model LESS 48)
        set(MICRO_ARCHITECTURE "amd-17h" "zen1")
      else()
        set(MICRO_ARCHITECTURE "amd-17h" "zen2")
      endif()
    elseif(_cpu_family EQUAL 22) # 16h
      if(_cpu_model LESS 16)
        set(MICRO_ARCHITECTURE "amd-16h" "jaguar")
      else()
        set(MICRO_ARCHITECTURE "amd-16h" "puma")
      endif()
    ...
    elseif(_cpu_family EQUAL 18) # 12h
      set(MICRO_ARCHITECTURE "amd-12h" "barcelona")
